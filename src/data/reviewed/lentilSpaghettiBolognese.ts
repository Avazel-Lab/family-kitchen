...
export const lentilSpaghettiBolognese: Recipe = {
  ...
  ingredients: [
    ...
    { id: 'onion', name: 'large onion', pluralName: 'large onions', quantity: 1, unit: 'count', note: 'finely diced' },
    { id: 'carrot', name: 'carrot', pluralName: 'carrots', quantity: 2, unit: 'count', note: 'finely diced or grated' },
    ...
    { id: 'beef-stock-or-water', name: 'water or low-salt beef stock', quantity: 200, unit: 'ml' },
    { id: 'dried-oregano', name: 'dried oregano', quantity: 2, unit: 'tsp' },
    { id: 'dried-basil', name: 'dried basil', quantity: 1, unit: 'tsp' },
    { id: 'worcestershire-sauce', name: 'Worcestershire sauce', quantity: 1, unit: 'tbsp' },
    { id: 'wholemeal-spaghetti', name: 'dry wholemeal spaghetti', quantity: 80, unit: 'g', quantityForPortions: 1, note: 'per adult-equivalent portion; a toddler portion is about half' }
  ],
  quickSteps: [
    ...
    'Cook the scaled amount of wholemeal spaghetti separately and serve with the sauce.'
  ],
  method: [
    ...
    'Cook the measured wholemeal spaghetti according to the packet, then drain and serve with the sauce.'
  ],
  variations: [
    {
    ...
    },
    {
      ...
      steps: [
        'Cook the dried lentils separately in unsalted water until tender, usually around 20–30 minutes depending on the type; follow the packet instructions.',
        'Drain thoroughly.',
