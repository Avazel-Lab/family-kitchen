...
export const pestoWholemealPastaBake: Recipe = {
  ...
  ingredients: [
    '225 g dry wholemeal penne, fusilli or similar',
    '1 x 400 g tin chopped tomatoes',
    '350 ml boiling water or low-salt vegetable stock, plus a little extra if needed',
    '150 g frozen broccoli florets, cut smaller if very large',
    '100 g frozen peas',
    '90–100 g pesto (about half a 190 g jar)',
  ...
  method: [
    ...
    'Put the dry wholemeal pasta, chopped tomatoes, 350 ml boiling water or stock and frozen broccoli into a large ovenproof baking dish. Stir well so the pasta is mostly submerged, then cover tightly with a lid or foil.',
    'Bake for 20 minutes.',
    'Remove carefully and stir thoroughly, especially around the edges and bottom where pasta can stick. Stir in the pesto and frozen peas. If the pasta has absorbed most of the liquid but is still firm, add another 50–100 ml boiling water.',
